                    ...
                    <form id="bookingForm" action="{{route('thanh-toan')}}" method="POST">
                        ...
                        @else
                            @guest
                                ...
                                <div class="form-group mx-3">
                                    ...
                                    <div class="form-group mx-3 my-3">
                                        <label class="mb-2">Thông tin: </label>
                                        <div class="row shadow-sm container">
                                            <div class="col-md-4">
                                                <label>Ngày : <strong id="check_date"></strong></label>
                                            </div>
                                            <div class="col-md-4"><label>Còn :
                                                    <strong style="color: #e34807"
                                                            id="remaining_tickets"></strong></label></div>
                                            <div class="col-md-4"><label>Giá vé: <strong style="color: #e34807"
                                                                                         id="tour_prices"></strong></label>
                                            </div>
                                        </div>
                                    </div>
                                    <script>
                                        function selectDate(date, quantity, prices) {
                                            ...
                                            document.getElementById('adults').addEventListener('input', function () {
                                                ...
                                                var personInput = this.value;
                                                const value = parseInt(personInput, 10);
                                                if (isNaN(value) || value < 1 || value > quantity) {
                                                    check.style.color = 'red';
                                                    check.innerText = 'Số lượng vé không hợp lệ';
                                                } else {
                                                    check.style.color = 'green';
                                                    check.innerText = 'Giá trị hợp lệ';
                                                }
                                            })
                                        }
                                    </script>
                                ...
                                <div class="form-group mx-3">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <small id="phoneHelp" class="form-text">Vui lòng nhập số điện thoại theo
                                                định dạng: +84xxxxxxxxx hoặc 0xxxxxxxxx.</small>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="col-md-4">
                                                <label for="adults" class="col-form-label text-center">Người lớn (>18
                                                    tuổi):</label>
                                            ...
                                            <div class="col-md-4">
                                                <label for="children" class="col-form-label text-center">Trẻ nhỏ (11-17
                                                    tuổi):</label>
                                            ...
                                            <div class="col-md-4">
                                                <label for="kids" class="col-form-label text-center">Trẻ em (0-10
                                                    tuổi):</label>
                            ...
                            @else
                                ...
                                <div class="form-group mx-3">
                                    ...
                                    <script>
                                        function selectDate(date, quantity, prices) {
                                            ...
                                            var kid = (kidsInput * prices) * 0.25;
                                            var adults = adultsInput * prices;
                                            var child = (childrenInput * prices) * 0.75;
                                            var sub_total = kid + adults + child;
                                            var discount = sub_total * (coupon / 100);
                                ...
                                <div class="row my-3 mx-2 shadow-sm">
                                    @php
                                ...
                                <div class="row justify-content-start align-content-lg-start">
                                    <div class="col-md-8 mx-5 my-3">
                                        ...
                                        <div class="row my-3 shadow-sm justify-content-center align-items-center">
                                            <div class="col-md-6"><small>Sub_Total: <strong
                                                        id="subtotal"></strong></small></div>
                                            <div class="col-md-6"><small>Giảm giá: - <strong
                                                        id="coupon_value"></strong></small></div>
                                        </div>
                                        <div class="row my-3 mx-2"><h5>Tổng thanh toán : </h5> <strong id="total"
                                                                                                       class="mx-2"
                                                                                                       style="color: #e34807"></strong>
                                        </div>
                                    </div>
                                </div>
                            @endguest
